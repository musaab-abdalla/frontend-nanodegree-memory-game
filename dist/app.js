...
function setupClicks() {
    ...
    function sweetAlert() {
        ...
        swal({
            title: "Excellent!",
            html: '<span class="win-massage"><i class="fa fa-retweet"></i>  ' + totalMoves + '</span>' +
                '<span class="win-massage"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>  ' + totalStar + '</span>' +
                '<span class="win-massage"><i class="fa fa-clock-o"></i>  ' + totalTime + '</span>',
            type: "success",
